                  ...
                  <div className="p-6">
                    <div className="flex flex-wrap items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Restaurant:{" "}
                          {order.restaurantName || "Campus Food Court"}
                        </p>
                    ...
                    {order.deliveryBoyId && (
                      <div className="mt-2 text-sm text-gray-600">
                        ...
                        {order.deliveryBoyName || "Assigned"}
                      </div>
                    )}
            ...
            >
              <div className="p-6 border-b">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Order #
                  {selectedOrderForAssign.orderNumber ||
                    selectedOrderForAssign.id.slice(-8)}
                </p>
              </div>
                  ...
                  <div className="space-y-3">
                    {deliveryBoys.map((boy) => (
                      <button
                        key={boy.id}
                        onClick={() =>
                          handleAssignDelivery(selectedOrderForAssign.id, boy)
                        }
                        disabled={assignLoading}
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-4 mt-2 text-xs text-gray-500">
                          ...
                          {boy.vehicleType && (
                            <span>Vehicle: {boy.vehicleType}</span>
                          )}
                        </div>
                      </button>
                    ))}
                  ...
                  <div className="border-t pt-4">
                    <div className="space-y-1">
                      <div className="flex justify-between text-sm">
                        ...
                        <span>
                          {formatCurrency(selectedOrder.subtotal || "0.00")}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">Tax</span>
                        <span>
                          {formatCurrency(selectedOrder.tax || "0.00")}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">Delivery Fee</span>
                        <span>
                          {formatCurrency(selectedOrder.deliveryFee || "0.00")}
                        </span>
                      </div>
                      <div className="flex justify-between font-bold text-lg pt-2">
                        <span>Total</span>
                        <span className="text-primary-600">
                          {formatCurrency(selectedOrder.total || "0.00")}
                        </span>
                      </div>
                    </div>
                  </div>
