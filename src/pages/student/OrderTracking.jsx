...
const OrderTracking = () => {
  ...
  const getStatusMessage = (status) => {
    const messages = {
      [ORDER_STATUS.PENDING]: 'Your order has been placed and is waiting for confirmation',
          ...
          <div className="lg:col-span-2">
            <GlassCard className="p-6">
              ...
              <div className="mb-6 p-4 bg-primary-50 rounded-lg">
                <p className="text-primary-700">{getStatusMessage(order.status)}</p>
              </div>
              ...
              {!isCancelled && (
                <div className="mb-8">
                  <div className="flex justify-between mb-2">
                    {['Pending', 'Confirmed', 'Preparing', 'Ready', 'Assigned', 'Picked', 'On Way', 'Delivered'].map((step, index) => (
                      <div
                        key={step}
                    ...
                    {order.statusHistory.map((history, index) => (
                      <div key={index} className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium">{ORDER_STATUS_LABELS[history.status]}</p>
              ...
              <div className="space-y-4">
                ...
                {!isCancelled && order.status !== ORDER_STATUS.DELIVERED && (
                  <div className="bg-primary-50 p-4 rounded-lg">
                    <p className="text-sm text-primary-700 font-medium">Estimated Delivery</p>
                ...
                {order.status === ORDER_STATUS.DELIVERED && order.deliveredAt && (
                  <div className="bg-green-50 p-4 rounded-lg">
                    <p className="text-sm text-green-700 font-medium">Delivered At</p>
